...
const getSpacedChildren = (children, space, axis, reverse, divider) => {
  ...
  if (divider) {
    ...
    childrenArray = childrenArray.map((child, index) => {
      ...
      }, child, disableCSSMediaQueries ? index < childrenArray.length - 1 && /*#__PURE__*/_react.default.createElement(_nativeBase.Box, spacingProp) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null));
    });
  }
